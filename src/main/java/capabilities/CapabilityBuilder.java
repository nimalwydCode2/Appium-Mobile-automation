...
public class CapabilityBuilder {
    ...
    public static BaseOptions<?> getAndroidCapabilities() {
        BaseOptions<?> caps = new BaseOptions<>();
        caps.setPlatformName("Android");
        caps.setDeviceName("Android Emulator");
        caps.setAutomationName("UiAutomator2");
        caps.setCapability("app", System.getProperty("user.dir") + "/apps/demo.apk");
        caps.setCapability("autoGrantPermissions", true);
        return caps;
    }

    public static BaseOptions<?> getIOSCapabilities() {
        BaseOptions<?> caps = new BaseOptions<>();
